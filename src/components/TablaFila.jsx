...
const TablaFila = ({ producto, setProductoAEditar }) => {
  ...
  return (
    <tr>
          ...
          <td>
            <button className="btn btn-sm mt-1" onClick={() => handleUpdate(producto)}>Editar</button>
            <button className="btn btn-sm mt-1" onClick={() => handleDelete(producto.id)}>Eliminar</button>
          </td>
    </tr>
  )
}
